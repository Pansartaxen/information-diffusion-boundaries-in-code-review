...
class TestNotebook(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self._notebook = self.execute_notebook('test/mock_notebook.ipynb')
    ...
    def execute_notebook(self, notebook_path) -> nbformat.NotebookNode:
        ...
        """
        if not os.path.isfile('data/minimal_paths/microsoft.pickle.bz2'):
    ...
    def test_notebook_outputs(self) -> None:
        ...
        if last_cell.outputs:
            ...
            image_disk = cv2.imread('test/Reference_pictures/output_test.png')
